...
daytrippr = Project.create!(name: 'Daytrippr', image: 'https://github.com/Saf3ty1nnumb3rs/portfolio_react_rails/raw/master/client/src/images/daytrippr.jpg', grade: 100, deploy_url: 'https://daytripperapp.herokuapp.com/', git_url: 'https://github.com/Saf3ty1nnumb3rs/daytripper_react_rails', description: 'This is WDI 14 Project 4 Day trips! Crowd source the best day trip destinations from around where you live or from around where you\'ll be visiting. Post tips, comments, and travel hacks for your fellow Daytripprs. Add a snapshot that you took from the locale and find new spots to TRIP!')
